...
namespace UI.ViewModels {
	public class ServiceProviderResponsesViewModel
	{
		private cBookingResponseRepository _BookingResponseRepository;

		public ServiceProviderResponsesViewModel()
		{
		...
		public List<cBookingResponse> BookingResponses
		{
			get
			{
				return _BookingResponseRepository.GetAll()
					.Where(x => x.BookingRequest.ServiceProviderId == cHelper.ServiceProvider.Id).ToList();
			}
		}
	}
}